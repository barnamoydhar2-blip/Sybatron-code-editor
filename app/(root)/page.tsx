...
export default function Home() {
  ...
  return (
    <div className=" z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-10">
      ...
      <h1 className=" z-20 text-6xl mt-5 font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-red-400 to-lime-400 dark:from-lime-400 dark:via-red-400 dark:to-cyan-400 tracking-tight leading-[1.3] ">
        Coding is fun with Syb-Code-Editor
      </h1>
      </div>
